...
superan ese límite y se publican como *assets* de la release `v1.0.0`; la app los descarga a `models/` la
primera vez que se seleccionan y verifica su SHA-256. La plataforma redespliega automáticamente en cada
`git push` a `main`. Configuración:
